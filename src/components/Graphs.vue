...
export default {
    ...
    created(){
        ...
        this.db_teste = convert_epoch(db_teste)
 ...
 */
 ...
 new Chart(chart_fin_elem, {
    type: 'line',
    data: {
        labels:["janeiro","fevereiro","março","febrero"], 
        datasets :[{
            backgroundColor: 'rgb(255, 99, 132)',
            borderColor: 'rgb(255, 99, 132)',
            data:grupo_sum(this.db_teste,'ds_tipificacao', 'vl_valor')}],
    options: {
        scales: {
            yAxes: [{
                ticks: {
    ...
    var chart_prot = document.getElementById('chart_prot')

    
    
    /* new Chart(chart_prot)
